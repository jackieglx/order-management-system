"""
URL configuration for day01_31 project.
...
from app01.views import level
from app01.views import customer
from app01.views import policy
from app01.views import my_order

urlpatterns = [
    # path('admin/', admin.site.urls),
    path('login/', account.login, name="login"),
    path('sms/', account.sms_login, name="sms_login"),
